...
The child forked by Zygote will launch ActivityThread.main() first, and call the ActivitymanagerService.attachApplication() by binder. In the applicationAttach(), AMS can get the AppInfo from the mPidsSelfLocked by the caller-pid.
